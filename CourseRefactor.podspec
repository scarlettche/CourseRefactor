#
# Be sure to run `pod lib lint CourseRefactor.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  s.name             = 'CourseRefactor'
  s.version          = '0.1.0'
  s.summary          = 'A short description of CourseRefactor.'
...
TODO: Add long description of the pod here.
  ...
  # s.resource_bundles = {
  #   'CourseRefactor' => ['CourseRefactor/Assets/*.png']
  # }
